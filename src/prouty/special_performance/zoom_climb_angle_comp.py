...
class ZoomClimbAngleComp(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('CT_sigma_max', val=0.12)
        self.add_output('gamma_c', val=0.8, units='rad')
        self.declare_partials('gamma_c', '*')

    def compute(self, inputs, outputs):
        outputs['gamma_c'] = np.arccos(inputs['CW_sigma'] / inputs['CT_sigma_max'])
    ...
    def compute_partials(self, inputs, J):
        ...
        J['gamma_c', 'CT_sigma_max'] = -d * cw / cm ** 2
